...
function printTable(result, tableId) {
    ...
    for (let i = 0; i < result.length; i++) {
        ...
        trtd += '<tr><td hidden><input type="text" name="order_id" value="' + data.order_id + '" style="width: 95%"></td>'
            ...
            + '<td><input type="text" name="order_state" value="' + order_state + '" style="width: 97%"><input type="text" hidden></td>'
            // + '<td><input type="text" name="order_type" value="' + order_type + '" readonly="readonly" style="width: 97%"></td>'
